...
class _ViewBillScreenState extends State<ViewBillScreen> {
  ...
  Future<void> _toggleStatus() async {
    ...
    if (billsData != null) {
      final List<Map<String, dynamic>> bills = List<Map<String, dynamic>>.from(jsonDecode(billsData));

      final int billIndex = bills.indexWhere((b) =>
      b['customerName'] == widget.bill['customerName'] && b['date'] == widget.bill['date']);
          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  pw.Text('Total: ${widget.bill['totalAmount'].toStringAsFixed(2)}',
                  ...
                  pw.Text('Status: $_status',
                      style: pw.TextStyle(
                          ...
                          color: _status == 'Paid' ? PdfColors.green : PdfColors.red)),
                ],
              ),
            ],
          );
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center, // Align text and button vertically centered
                  children: [
                    IntrinsicHeight(
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          ...
                          children: <Widget>[
                            ...
                            ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                ...
                                padding: EdgeInsets.symmetric(horizontal: 16, vertical: 10), // Adjust button padding
                              ),
                              onPressed: () async {
                                await _toggleStatus();
                              ...
                              child: Text(
                                _status == 'Paid' ? 'Mark as Unpaid' : 'Mark as Paid',
